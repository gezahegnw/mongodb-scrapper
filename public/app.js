$(document).ready(function(){
  ...
  function displayArticles(){
    $.getJSON("/articles", function(data) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        //var newImage = $('<img>', { width : 350, height : 250, src : data[i].image});
       var newImage = $('<img>', { width : 350, height : 250, src : data[i].image});
  ...
  $(document).on("click", ".note-button", function() {
    ...
    .then(function(data) {
      ...
      $("#noteModalBody").empty()
      $("#noteModalLabel").append(data.title +"<br> <textarea class='form-control' id='titleinput' rows='2' placeholder='Note Title'></textarea>")
